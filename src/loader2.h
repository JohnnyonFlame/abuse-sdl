...
/******************************* SOUND EFFECTS **********************************/
extern int raise_volume, lower_volume, record_button, play_button, music_button,
		sfx_button;
...
/******************************** SCREEN FRAME **********************************/
extern int border_tile, window_texture, record_button, play_button,
		window_colors, pause_image, vmm_image, earth, earth_mask, clouds,
		numbers[10], stat_bar, ok_button, cancel_button, cdc_logo;
