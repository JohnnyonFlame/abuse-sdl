...
public:
	...
	void calc_range();
	light_source(char Type, int32_t X, int32_t Y, int32_t Inner_radius,
			int32_t Outer_radius, int32_t Xshift, int32_t Yshift,
			light_source *Next);
	light_source *copy();
};
...
public:
	...
	light_source **lights;
	light_patch *next;
	light_patch(int32_t X1, int32_t Y1, int32_t X2, int32_t Y2,
			light_patch *Next) {
		x1 = X1;
		y1 = Y1;
		x2 = X2;
	...
	void add_light(int32_t X1, int32_t Y1, int32_t X2, int32_t Y2,
			light_source *who);
