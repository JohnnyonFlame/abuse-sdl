...
public:
	...
	void draw_value(image *screen, int x, int y, int w, int h, int val,
			int max);
	...
	void mouse_to_game(int32_t x, int32_t y, int32_t &gamex, int32_t &gamey,
			view *v = NULL);
	void game_to_mouse(int32_t gamex, int32_t gamey, view *which, int32_t &x,
			int32_t &y);
	...
	void show_time();tile_type get_map_bg(int x, int y) {
...
extern void set_gamma(int gamma);
