...
public:
	...
	void do_damage(int amount, game_object *from, int32_t hitx, int32_t hity,
			int32_t push_xvel, int32_t push_yvel);
	void damage_fun(int amount, game_object *from, int32_t hitx, int32_t hity,
			int32_t push_xvel, int32_t push_yvel);
	...
	game_object *try_move(int32_t x, int32_t y, int32_t &xv, int32_t &yv,
			int checks); // 1=down,2=up,3=both
...
game_object *create(int type, int32_t x, int32_t y, int skip_constructor = 0,
		int aitype = 0);
int base_size();
