...
char const *ability_names[TOTAL_ABILITIES] = { "start_hp", "start_accel",
		"stop_accel", "jump_xvel", "jump_yvel", "run_top_speed",
		"jump_top_speed", "tint_color", "push_xrange", "walk_top_speed" };
